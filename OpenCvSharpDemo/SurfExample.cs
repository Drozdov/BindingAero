...
namespace OpenCvSharpDemo
{
    ...
    internal class SURFSample
    {
        public SURFSample()
        {
            ...
            using (IplImage obj = Cv.LoadImage("../../../man_obj.png", LoadMode.GrayScale))
            using (IplImage image = Cv.LoadImage("../../../man_scene.png", LoadMode.GrayScale))
            ...
            using (IplImage correspond = Cv.CreateImage(new CvSize(image.Width, obj.Height + image.Height), BitDepth.U8, 1))
            {
                ...
                {
                    CvSURFParams param = new CvSURFParams(300, true);
